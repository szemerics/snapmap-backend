...
Copy the example env file and fill in real values (JWT and Cloudinary). For local MongoDB without Docker, set `MONGODB_URI` to your connection string (seen after you connect with `mongosh`).
